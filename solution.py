...
class SOLUTION:
    ...
    def Create_Brain(self):
        ...
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+2 , jointName = "Torso_Rightleg")
        pyrosim.Send_Motor_Neuron( name = c.numSensorNeurons+3 , jointName = "Torso_Leftleg")
